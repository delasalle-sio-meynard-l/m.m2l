...
if ($laReservation) {
	$dao->annulerReservation("5");
	$laReservation = $dao->getReservation("5");
	if ($laReservation)
		echo "La réservation 5 n'a pas été supprimée !</p>";
	else
		echo "La réservation 5 a bien été supprimée !</p>";
}
else
...
$ok = $dao->aPasseDesReservations("giboired");
if ($ok)
	echo "<p>giboired a bien passé des réservations !<br>";
else
	echo "<p>giboired n'a pas passé de réservations !<br>";
...
$dao->modifierMdpUser("guesdonm", "passe");
$ok = $dao->envoyerMdp("guesdonm", "passe");
if ($ok)
